...
int main()
{
    ...
    iota(all(loc),0LL);
    vll nestlabel(n + 1);
    iota(all(nestlabel),0LL);
    vll labelnest(n + 1);
    iota(all(labelnest),0LL);
    ...
    rep(q)
    {
        ...
        {
            sll(a,b);
            ll origboxA = labelnest[a];
            ll origboxB = labelnest[b];
            swap(labelnest[a],labelnest[b]);
            swap(nestlabel[origboxA],nestlabel[origboxB]);
        }
        else
        {
            sll(a);
