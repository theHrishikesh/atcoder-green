...
int main()
{
    ...
    ll even_containing_subsets = (1LL << evencnt);

    ll even_sized_odd_containing_subsets = (1LL << (oddcnt - 1));
    ll odd_sized_odd_containing_subsets = (1LL << (oddcnt - 1));
    
    if (p == 0)
    {
        if (oddcnt == 0) ways = (1LL << n);
        else ways = even_containing_subsets * even_sized_odd_containing_subsets;
    }
    else
    {
        ways = (odd_sized_odd_containing_subsets * even_containing_subsets);
    }
    out(ways);
